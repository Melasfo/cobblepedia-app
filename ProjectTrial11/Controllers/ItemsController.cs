...
namespace ProjectTrial11.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Category,Effect")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Category,Effect")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
