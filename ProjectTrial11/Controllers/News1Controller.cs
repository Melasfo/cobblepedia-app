...
namespace ProjectTrial11.Controllers
{
    ...
    public class News1Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NewsTitle,NewsDescription")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NewsTitle,NewsDescription")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
